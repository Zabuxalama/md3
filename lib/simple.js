...
exports.smsg = (conn, m, hasParent) => {
     ...
     */
     m.reply = async (text, chatId, options) => {
        ...
        conn.reply(chatId ? chatId : m.chat, text, m, { contextInfo: { mentionedJid: conn.parseMention(text), externalAdReply: { title: 'Join Group Miaw-Bot', body: wm, sourceUrl: 'https://chat.whatsapp.com/BGSa9GAjPGo3T7LPTPldIx', thumbnail: data }}, options })
    }
